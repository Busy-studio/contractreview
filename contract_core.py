...
먼저 확인할 사항:
- 이 계약이 국가연구개발과제 협약 또는 그 하위 계약인지 여부
- 정부출연금, 정부재원, 전문기관, 연구개발과제, 협약, 주관연구개발기관, 공동연구개발기관, 위탁연구개발기관 관련 표현 존재 여부
...
다만, 단순히 불리 조항을 찾는 것에 그치지 말고, 먼저 계약의 성격과 적용 가능한 법령·규정의 범위를 판단한 뒤 그 범위 내에서만 검토하라.
특히 대학에 불리할 수 있는 조항을 식별하되, 반드시 제공된 관련 규정 및 법령 발췌에서 직접 근거를 확인할 수 있는 경우에만 문제 조항으로 제시하라.

가장 먼저 해야 할 판단:
- 우선 계약서의 명칭, 목적, 당사자, 비용 부담 구조, 연구개발비 재원, 과제명, 전문기관 또는 정부출연금 언급 여부, 협약 체계 등을 바탕으로 이 계약의 성격을 먼저 판별하라.
- 아래 유형 중 어디에 해당하는지 먼저 정리하라.
  1. 국가연구개발과제 협약 또는 그 하위 계약
  2. 정부재원이 포함된 공동연구 또는 위탁연구 계약
  3. 민간재원 기반 공동연구 계약
  4. 일반 용역, 시험, 분석, 자문, 검증, 평가 계약
  5. 기술이전, 실시권, 옵션, 우선협상권 관련 계약
  6. 혼합형 계약

적용 법령 및 규정 판단 원칙:
- 계약 유형에 따라 실제로 적용 가능한 법령과 규정만 근거로 사용하라.
- 국가연구개발혁신법, 국가연구개발혁신법 시행령, 국가연구개발사업 관련 규정은 해당 계약이 국가연구개발과제 또는 정부재원이 포함된 과제와 직접 관련된 경우에만 우선 검토하라.
- 단순 민간재원 용역계약, 민간 공동연구계약, 시험·분석·자문 계약에 대해서는 국가연구개발혁신법을 자동으로 적용하지 말라.
- 국가연구개발과제 해당 여부가 계약서상 명확하지 않으면 이를 단정하지 말고 "추가 확인 필요"로 처리하라.
- 적용 여부가 불분명한 법령을 근거로 상세 검토 결과를 작성하지 말고, [추가 권고]에서 확인 필요사항으로만 제시하라.
- 공공계약 예규, 국가계약 관련 일반조건, 지방계약 관련 기준은 해당 계약이 실제로 국가기관·공공기관 발주 계약이거나 그 준용이 명시된 경우에만 적용 가능 법령/규정 목록에 포함하라.
- 대학과 민간기업 간 일반 공동연구계약 또는 기술용역계약의 경우, 공공계약 예규를 우선 근거로 사용하지 말고 대학 내부 규정, 민법, 지식재산권 관련 법령, 계약서상 준거 조항을 우선 검토하라.
...
- 예시 형식:
  ...
  - 국가연구개발혁신법 제16조
- 단, 국가연구개발혁신법 등 국가연구개발 관련 법령은 이 계약이 실제로 그 법령의 적용 대상이라고 판단되는 경우에만 근거로 사용할 수 있다.
- 근거 문서명이나 조문 번호를 특정할 수 없으면 그 항목은 출력하지 말라.
- 일반론, 추정, 관행, 취지만으로는 문제 조항으로 제시하지 말라.
- 적용 가능성이 불명확한 법령은 상세 검토 결과의 근거로 사용하지 말라.
- "추가 확인 필요"는 쓸 수 있지만, 그 경우에도 왜 근거 특정이 어려운지 설명해야 하며, "상세 검토 결과" 항목으로는 올리지 말고 [추가 권고]에만 적어라.
- 즉, [상세 검토 결과]에는 해당 계약 유형에 실제 적용 가능한 근거 문서가 특정되는 항목만 포함하라.

검토 방식:
- 먼저 계약 유형과 국가연구개발과제 해당 여부를 판단하라.
- 그 다음 본 계약에 실제로 적용 가능한 법령 및 규정을 좁혀서 식별하라.
- 적용 가능성이 낮은 법령이나 단순 참고 수준의 규정은 "우선 적용 검토 법령/규정"에 넣지 말라.
- 특히 민간기업-대학 계약에서 공공계약 예규는 계약서상 준용 규정이 없으면 원칙적으로 제외하라.
- "우선 적용 검토 법령/규정(복수)"에는 실제 상세 검토 결과에서 근거로 사용할 가능성이 높은 규정만 기재하라.
...
- 이후 상세 검토에서는 위 목록 중 실제로 근거로 특정 가능한 조문이 있는 경우에만 사용하라.
- 그 후 문제가 되는 조항을 계약서 원문 문장을 가능한 그대로 인용하여 제시하라.
- 문제가 되는 조항은 반드시 계약서 상의 조항 번호(예: 제○조 제○항)를 포함하여 표시하라.
- 조항 원문 인용 시에는 해당 문장이 포함된 조항 번호를 함께 제시하라.
- 조항 번호를 확인할 수 없는 경우에는 해당 항목을 출력하지 말라.
- 각 항목은 계약서 조항 + 실제 근거 문서 + 수정 예시가 모두 있어야 한다.
- 근거 문서가 없는 항목은 제외하라.
- 조항 변경 예시는 실제 대학-기업 산학협력 계약서에서 통상 사용하는 문체와 수준으로 작성하라.
- 수정 예시는 계약서에 반영 가능한 조항 문안으로 작성하되, 기존 계약 조항의 형식과 톤을 최대한 유지하라.
- 지나치게 경직된 법률문체나 과도하게 공격적인 면책 문구는 피하고, 실무적으로 수용 가능한 균형 잡힌 문안으로 작성하라.
- 설명문이나 해설문이 아니라 실제 계약서에 들어갈 수 있는 자연스러운 조항 문장으로 작성하라.
- 수정 예시가 원 조항보다 대학에 더 불리해지면 안 된다.
- 다음과 같이 대학에 과도한 책임 또는 보증으로 해석될 수 있는 표현은 사용하지 말고, 해당 개념이 포함된 경우에는 삭제하거나 책임 범위를 제한하는 방향으로 수정하라:
  · "보증", "보장", "확인한다"
  · "침해하지 않는다", "하자가 없다", "완전하다", "적합하다"
  · "일체의 책임", "모든 책임", "전적으로 책임진다"
  · "배상한다", "손해를 전부 부담한다"
- 수정 예시는 새로운 의무나 보증을 추가하는 것이 아니라, 기존 조항의 위험을 완화하거나 책임 범위를 합리적으로 제한하는 방향으로 작성하라.
...
[추가 권고]
- 국가연구개발과제 해당 여부 또는 재원 구조 확인 필요 사항
