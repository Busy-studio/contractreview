...
[문제 요약]
- 해당 조항의 핵심 문제를 1~2줄로 정리

[문제 상세]
- 문제되는 이유를 대학 입장에서 개조식으로 설명
...
■ 추가 검토 필요 사항
- 근거 문서 부족 또는 적용 여부가 불명확하여 상세 검토 결과에는 포함하지 않은 사항

■ 계약 협상 시 반영 필요 사항
- 실무적으로 수정 또는 협의가 필요한 사항

■ 확인 필요 문서
- 추가 검토가 필요한 내부 규정 또는 관련 문서
