...
- 그 다음 본 계약 유형에 적용 가능성이 있는 모든 관련 법령 및 내부 규정을 최대한 폭넓게 식별하라.
- 단, 계약 유형과 명백히 무관한 법령(예: 국가연구개발과제와 무관한 경우의 국가연구개발혁신법 등)은 제외하라.
- 결과는 "적용 가능성이 있는 법령/규정 목록" 형태로 복수 개를 나열하라.
...
- 근거 문서가 없는 항목은 제외하라.
- 조항 변경 예시는 실제 대학-기업 산학협력 계약서에서 일반적으로 사용되는 수준의 문체로 작성하라.
- 과도하게 공격적이거나 일방적으로 책임을 면제하는 문장이 아니라, 실무적으로 수용 가능한 균형 잡힌 문장으로 작성하라.
- 법률 교과서식 표현보다는 실제 계약서에서 사용하는 자연스러운 조문 형태로 작성하라.
